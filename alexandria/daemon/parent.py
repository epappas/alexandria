...
class DaemonParent:
    ...
    def _startup_cleanup(self) -> None:
        ...
        with connect(db_path(self._home)) as conn:
            ...
            # Sweep orphaned runs
            from alexandria.core.runs import sweep_orphaned_runs
            ...
            from alexandria.core.adapters.source_repository import sweep_orphaned_source_runs
