"""``llmwiki why`` — belief explainability with provenance + history."""
...
from llmwiki.core.beliefs.repository import BeliefQuery, query_beliefs
...
def why_command(
    ...
    with connect(db_path(home)) as conn:
        ...
        from llmwiki.core.beliefs.repository import get_belief
    ...
    if not beliefs and not history:
        ...
        console.print("[dim]Beliefs are created when content is ingested (llmwiki ingest).[/dim]")
        return
