...
A workspace is a directory under ``<llmwiki_home>/workspaces/<slug>/`` with a
...
a materialized view that ``llmwiki reindex`` can rebuild from disk.
"""
